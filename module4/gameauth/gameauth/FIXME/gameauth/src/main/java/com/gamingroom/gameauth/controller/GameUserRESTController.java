...
// FIXME: 3Done - Add path annotation for gameusers 
...
public class GameUserRESTController {
    ...
    // FIXME: 8Done - Add RolesAllowed annotation for USER based on BasicAuth Security Example 
    ...
    // FIXME: 7Done - Add RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
