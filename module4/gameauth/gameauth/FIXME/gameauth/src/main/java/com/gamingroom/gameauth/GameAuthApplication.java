...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// FIXME: 1Done - Register GameUserRESTController (based on BasicAuth Security Example)
		// FIXME: 2Done - Create io.dropwizard.client.JerseyClientBuilder instance and give it io.dropwizard.setup.Environment reference (based on BasicAuth Security Example)
		
		e.jersey().register(new GameUserRESTController(e.getValidator() /*, new GameUserDB*/));
